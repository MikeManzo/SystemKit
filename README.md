...
[libtop](http://www.opensource.apple.com/source/top/top-100.1.2/libtop.c), from Apple's top implementation.  Forked from [The Original](https://github.com/beltex/SystemKit) and updated to swift 5.x with [Swift Package Manager](https://swift.org/package-manager/) support (see below).
